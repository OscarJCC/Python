...
raiz.title("IntGrafic_6_Calculadora")
raiz.config()
...
Pantalla.grid(row = 1, column = 1, padx = 0, pady = 0, columnspan = 4) # columspan = numero de celdas que avarcara
                                                                         # Permite hacer que el cuadro se extienda sobre esas columnas en vertical
